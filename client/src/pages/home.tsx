...
export default function Home() {
  ...
  const functions = [
    ...
    { id: 5, title: "Conservative Extension Analysis (Two Arguments)", description: "Analyze extensions for conservativity.", dualInput: true },
    { id: 6, title: "Compare Conceptual Schemes (Two Arguments)", description: "Compare primitive/derived classifications.", dualInput: true },
