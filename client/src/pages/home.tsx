export default function Home() {
  ...
  const podcasts = [
    { title: "BPD Podcast", url: null, note: "AI-Generated by Zhi Systems" }
  ];
    ...
    <div className="font-sans bg-white text-gray-900 leading-relaxed min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="mb-16">
          ...
          {/* What's a Zhi Systems Podcast explanation */}
          <div className="mb-6 p-4 bg-green-50 rounded-lg border border-green-200">
            <p className="text-gray-700 text-sm leading-relaxed">
              <strong>AI-Generated Podcasts:</strong> These podcasts are entirely generated by Zhi Systems AI applications. 
              From script writing to voice synthesis, our AI creates engaging audio content on various topics, 
              demonstrating the power of fully automated content creation.
            </p>
          </div>
          
          <div className="grid gap-3">
            {podcasts.map((podcast) => (
              <BookItem key={podcast.title} title={podcast.title} url={podcast.url} note={podcast.note} />
            ))}
          </div>
        </section>
