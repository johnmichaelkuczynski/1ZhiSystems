...
Generate the axiom set now. Start directly with "LANGUAGE:" - no other text.`;
  ...
  return (
    <div className="border border-border rounded-sm bg-card h-full flex flex-col">
      ...
      <div className="p-3 space-y-3 border-b border-border">
        <div className="grid grid-cols-2 gap-2">
          <div className="space-y-1">
            <label className="text-[10px] font-mono text-muted-foreground uppercase">Number of Axioms</label>
            <Input
              type="number"
              min="1"
              max="20"
          ...
          <div className="space-y-1">
            ...
            <Select value={axiomType} onValueChange={setAxiomType}>
              <SelectTrigger className="h-8 text-xs" data-testid="select-axiom-type">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                {axiomTypes.map(type => (
        ...
        <div className="space-y-1">
          ...
          <Textarea
            ...
            placeholder="e.g., reflexive, transitive, includes successor function, dense ordering..."
