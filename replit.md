...
- **Full Article Processing**: August 22, 2025 - Added "CREATE FULL COGNITIVE MAP", "CREATE FULL STUDY GUIDE", and "CREATE FULL REWRITE" buttons alongside existing "CREATE FULL PODCAST" button for processing entire journal articles
